...
## 📅 마지막 업데이트: 2026-04-18 (시스템 원상복귀 완료)

> [!IMPORTANT]
> **2026-04-18 23:23**: 프로젝트를 2026-04-15 09:00 직전 상태(`80473f1` 커밋)로 강제 롤백(Reset) 하였습니다.
> 4월 14일 15:22 이후의 모든 작업 내역과 설정이 초기화되었습니다.

> [!NOTE]
> **2026-04-19 12:58**: 롤백 이후 해제되었던 일일 파이프라인 자동 스케줄러(`launchd - com.btcn.daily-pipeline.plist`) 재등록 및 가상환경 경로 최적화 복구 완료. 매일 00:00 KST 자동 학습이 정상 동작합니다.
